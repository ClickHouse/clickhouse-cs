...
/// <see cref="ClickHouseTcpConnectionException"/> and <see cref="ClickHouseTcpProtocolException"/> under
...
public static class TcpErrorsAndRetries
{
    ...
    private static void TheHierarchy()
    {
        ...
        Console.WriteLine("     ClickHouseTcpConnectionException           the socket failed: refused, dropped, TLS");
    ...
    private static async Task Transient(ClickHouseTcpClient client)
    {
        ...
        Console.WriteLine("                 and every ClickHouseTcpConnectionException");
    ...
    private static async Task RetryingAnInsert(ClickHouseTcpClient client)
    {
        ...
        // The failure mode: a retry after a connection error that in fact delivered the rows.
        ...
        Console.WriteLine();
        Console.WriteLine("   And an insert that fails with a ClickHouseTcpConnectionException may or may not have");
