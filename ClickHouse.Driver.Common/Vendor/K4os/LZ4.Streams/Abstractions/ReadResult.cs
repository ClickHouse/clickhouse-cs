...
namespace ClickHouse.Driver.Vendor.K4os.Compression.LZ4.Streams.Abstractions;
...
internal record struct ReadResult<TStreamState>(TStreamState Stream, int Bytes);
