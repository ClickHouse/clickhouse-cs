...
using ClickHouse.Driver.Vendor.K4os.Compression.LZ4.Internal;
...
using ClickHouse.Driver.Vendor.K4os.Hash.xxHash;
...
/// LZ4 stream encoder. 
/// </summary>
internal partial class LZ4FrameWriter<TStreamWriter, TStreamState>:
	ILZ4FrameWriter
