...
using ClickHouse.Driver.Vendor.K4os.Compression.LZ4.Encoders;
using ClickHouse.Driver.Vendor.K4os.Compression.LZ4.Streams.Abstractions;
using ClickHouse.Driver.Vendor.K4os.Compression.LZ4.Streams.Adapters;
using ClickHouse.Driver.Vendor.K4os.Compression.LZ4.Streams.Internal;

namespace ClickHouse.Driver.Vendor.K4os.Compression.LZ4.Streams.Frames;
...
internal class ByteBufferLZ4FrameWriter<TBufferWriter>:
...
/// <see cref="ILZ4FrameWriter"/> implementation for <see cref="IBufferWriter{T}"/>
/// </summary>
internal class ByteBufferLZ4FrameWriter: ByteBufferLZ4FrameWriter<IBufferWriter<byte>>
{
	/// <summary>
...
/// </summary>
internal class ByteMemoryLZ4FrameWriter: LZ4FrameWriter<ByteMemoryWriteAdapter, int>
{
	/// <summary>
...
/// one way or another.
/// </summary>
internal class ByteSpanLZ4FrameWriter: LZ4FrameWriter<ByteSpanAdapter, int>
{
	/// <summary>
...
/// </summary>
internal class StreamLZ4FrameWriter: LZ4FrameWriter<StreamAdapter, EmptyState>
{
