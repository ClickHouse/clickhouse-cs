...
public interface IClickHouseClient : IDisposable
{
    ...
    /// </summary>
    /// <param name="table">The destination table name.</param>
    /// <param name="stream">The stream containing the data to insert. The caller keeps ownership of it: the driver reads from the stream but never disposes it.</param>
