...
/// <see cref="System.DateOnly"/>, a String column as <see cref="string"/>/<c>byte[]</c>. Such implementations
/// are explicit, since they differ only by return type. Every <see cref="ReadValue"/> must consume exactly
/// the bytes <see cref="ClickHouseType.Read(ExtendedBinaryReader)"/> would.
/// </summary>
