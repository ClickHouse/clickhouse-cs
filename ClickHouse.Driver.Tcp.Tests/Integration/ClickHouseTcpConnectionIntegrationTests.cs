...
public class ClickHouseTcpConnectionIntegrationTests
{
    ...
    [Test]
    public void ConnectAsync_ToUnreachablePort_ThrowsConnectionExceptionNamingTheEndpointAndKeepingTheSocketError()
    {
        // Port 1 is reserved and never accepts native-protocol connections.
        var thrown = Assert.ThrowsAsync<ClickHouseTcpConnectionException>(async () =>
