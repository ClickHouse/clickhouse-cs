...
/// <summary>
/// Turns the runtime's socket and stream failures into <see cref="ClickHouseTcpConnectionException"/>.
/// </summary>
/// <remarks>
...
internal static class ConnectionFailure
{
    ...
    internal static ClickHouseTcpConnectionException Read(Exception cause) =>
        new("Reading from the ClickHouse connection failed.", cause);

    /// <summary>Wraps a failure that broke a write.</summary>
    internal static ClickHouseTcpConnectionException Write(Exception cause) =>
    ...
    internal static ClickHouseTcpConnectionException Connect(string host, int port, Exception cause) =>
    ...
    /// </summary>
    internal static ClickHouseTcpConnectionException EndOfStream() =>
        new(
