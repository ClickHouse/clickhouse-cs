...
internal sealed class ClickHouseTcpConnection : IDisposable, IAsyncDisposable
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        finally
        {
            ...
            {
                // Cancellation, a read that gave up, a broken transport, or a consumer that stopped enumerating.
                // In each case the server is still producing a result nobody will read, so tell it to stop.
